...
export default class CypherListener extends antlr4.tree.ParseTreeListener {
	...
	enterOC_InQueryCall(ctx) {
	}

	// Exit a parse tree produced by CypherParser#oC_InQueryCall.
	exitOC_InQueryCall(ctx) {
	}


	// Enter a parse tree produced by CypherParser#oC_SubQuery.
	enterOC_SubQuery(ctx) {
	}

	// Exit a parse tree produced by CypherParser#oC_SubQuery.
	exitOC_SubQuery(ctx) {
	}
