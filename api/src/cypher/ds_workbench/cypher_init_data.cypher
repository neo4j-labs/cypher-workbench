...
// create AdminOrg security organization, add allowed email domains
MERGE (s:SecurityOrganization {name:'AdminOrg'})
SET s.type = 'organization'
SET s.code = 'ADMINCODE'
SET s.enterpriseDomains = ['adminorg.com']
SET s:DefaultPublic

MERGE (emailDomain:EmailDomain {name:'adminorg.com'})
MERGE (emailDomain)-[:BELONGS_TO]->(s)
...
// add AdminOrg as licensed for Enterprise
